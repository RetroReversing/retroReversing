...
{% include_cached link-to-other-post.html post="/zelda-links-awakening-dx" description="For the full Zelda DX source archive and the wider Disk 1 demo workspace where this folder was found, check out this post." %}
...
{% include_cached link-to-other-post.html post="/gameboy-development-kit-hardware" description="For the wider hardware side of this setup, including Nintendo's DMG-ICE and related Game Boy development hardware, check out this post." %}
