...
When it comes to finding a game to reverse engineer it can be helpful to look at games that are cross-platform to compare builds. But the most valuable reverse engineering projects tend to be the platform exclusives as these are games people can no longer play on modern consoles. The website `N64 Squid` has compiled an excellent list of games that have never been re-released and thus need N64 hardware to be able to play:
[List of Nintendo 64 Exclusive Games - N64 Squid](https://n64squid.com/faq/list-of-nintendo-64-games/exclusive/)

{% include link-to-other-site.html url="https://n64squid.com/faq/list-of-nintendo-64-games/exclusive/" description="List of Nintendo 64 Exclusive Games - N64 Squid" image="" title="Exclusive Games"  %}
...
---
# Retail N64 hardware
When the N64 was launched it was the most powerful game console on the market and brought incredible processing power into the home. The hardware was state of the art and exploring how it was developed is a facinating topic.
...
## Cartridge
Nintendo made the controversial decision to continue using cartridges for its next-gen console after the Super Nintendo, this has the benenfit of excellent loading times compared to CDs but came at the cost of a smaller capacity and higher cost to produce.
