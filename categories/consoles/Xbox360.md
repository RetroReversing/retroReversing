...
{% include_cached link-to-other-post.html post="/microsoft-xbox-360-development-kit" description="For information about Microsoft's Xbox development hardware check out this post." %}
